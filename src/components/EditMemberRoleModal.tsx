...
export function EditMemberRoleModal({
  ...
  // Check if the member is a Developer
  const memberIsDeveloper = member?.role === "Developer";
  const canEditDeveloper = permissions.isDeveloper();
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  <div className="p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {memberIsDeveloper && !canEditDeveloper && (
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <div className="text-sm font-medium text-purple-400 mb-1">
                                Developer Role Protected
                              </div>
                              <div className="text-xs text-purple-300/80">
                                Only users with the Developer role can change the role of another Developer. This is a security measure to protect the highest level of system access.
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          disabled={memberIsDeveloper && !canEditDeveloper}
                          className="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-4 py-3 text-gray-100 focus:outline-none focus:ring-2 focus:ring-cinematic-blue-500 focus:border-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                  ...
                  <div className="border-t border-gray-800 p-6 flex gap-3">
                    ...
                    <button
                      type="submit"
                      disabled={isPending || (memberIsDeveloper && !canEditDeveloper)}
