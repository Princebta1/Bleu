...
import { submitRoleTemplateFeedback } from "~/server/trpc/procedures/submitRoleTemplateFeedback";
import { getRoleTemplateFeedback } from "~/server/trpc/procedures/getRoleTemplateFeedback";
import { updateRoleTemplateFeedback } from "~/server/trpc/procedures/updateRoleTemplateFeedback";
...
export const appRouter = createTRPCRouter({
  ...
  deleteRole,
  cloneRole,
  submitRoleTemplateFeedback,
  getRoleTemplateFeedback,
  updateRoleTemplateFeedback,
